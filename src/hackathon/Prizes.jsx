            ...
            <div className="max-w-7xl mx-auto px-6 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="group relative">
                        ...
                        <div className="relative bg-white rounded-3xl p-8 shadow-2xl border-2 border-yellow-200 hover:border-yellow-300 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
                            {/* Crown/Badge */}
                            ...
                            <div className="text-center mb-6">
                                ...
                                {/* <p className="text-gray-600">Cash Prize + Trophy</p> */}
                            </div>
                    ...
                    <div className="group relative">
                        ...
                        <div className="relative bg-white rounded-3xl p-8 shadow-2xl border-2 border-gray-200 hover:border-gray-300 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
                            ...
                            <div className="text-center mb-6">
                                ...
                                {/* <p className="text-gray-600">Cash Prize + Medal</p> */}
                            </div>
                    ...
                    <div className="group relative">
                        ...
                        <div className="relative bg-white rounded-3xl p-8 shadow-2xl border-2 border-orange-200 hover:border-orange-300 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
                            ...
                            <div className="text-center mt-6 mb-6">
                                ...
                                <h3 className="text-2xl font-bold text-gray-800 mb-2">Third Place</h3>
                ...
                <div className="text-center bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-gray-700">
                        <div className="flex flex-col items-center space-y-2">
                            ...
                            <span className="font-semibold">Best Innovation</span>
                            <span className="text-sm text-gray-600">Special Recognition Award</span>
                        </div>
                        <div className="flex flex-col items-center space-y-2">
                            <div className="bg-green-100 rounded-full p-3">
                                <Trophy className="w-6 h-6 text-green-600" />
                            </div>
                            <span className="font-semibold">People's Choice</span>
                            <span className="text-sm text-gray-600">Voted by Community</span>
                        </div>
                        <div className="flex flex-col items-center space-y-2">
                            <div className="bg-purple-100 rounded-full p-3">
                                <Award className="w-6 h-6 text-purple-600" />
                            </div>
                            <span className="font-semibold">Best Design</span>
                            <span className="text-sm text-gray-600">UI/UX Excellence</span>
                        </div>
                    </div>
                </div>
            </div>
