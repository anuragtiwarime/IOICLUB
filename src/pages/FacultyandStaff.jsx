...
const FacultyandStaff = () => {
  const facultyData = [
    ...
    
    {
      ...
      name: "Shubham Gautam",
      subject:"Operating Systems and Networks (OS&N)",
      ...
      linkedin:"https://www.linkedin.com/in/shubhamgautamsuper30/"
    ...
    },
    {
      ...
      linkedin:"https://drive.google.com/file/d/1oWth3anvkNHsLwVxqb4AWWRpqDDXJ-Dv/view?usp=sharing"
    ...
    },
    {
      ...
      linkedin:"https://www.linkedin.com/in/kaibalya-biswal-701b6421a/"
    ...
    },
    {
      ...
      linkedin:"https://www.linkedin.com/in/gaurfarmaiyein/"
    ...
    },
    {
      ...
      linkedin:"https://www.linkedin.com/in/anisha-koshy/"
    },
    {
      ...
      linkedin:"https://www.linkedin.com/in/kinjal-sengupta/"
    },
    {
    ...
    },
    {
      ...
      linkedin:"https://www.linkedin.com/in/nitin-manjunath-110169136/"
    ...
    {
      image:"https://res.cloudinary.com/dkxongd5z/image/upload/v1737351700/Anukul_ia8tpl.jpg",
      name:"Anukul Nitin Narkhede",
      subject:"",
      about:"I am currently building the School of Management at Physics Wallah as a program manager, where I design and implement innovative, hands-on learning programs that drive student success and foster a dynamic campus culture. A graduate of Masters’ Union, I bring a strong foundation in problem-solving and innovation to my work. Previously, I founded Cproz Tech, an education startup that streamlined student support through technology, impacting over 50,000 users. With over 6 years of experience in education entrepreneurship and program management, I am passionate about creating meaningful, scalable learning experiences.",
      linkedin:"https://www.linkedin.com/in/anukulnarkhede/"
    }
