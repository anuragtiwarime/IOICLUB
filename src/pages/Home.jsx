  ...
  return (
    <div className="pt-16">
      ...
      <section className="py-16 px-4">
        <h2 className="text-3xl font-bold text-center text-black mb-12">Campus Life</h2>
        ...
        <div className="text-center mt-8">
          <a
            ...
            className="inline-block bg-black text-white py-2 px-6 rounded hover:bg-gray-800 transition-colors"
          >
            View More
          </a>
        </div>
