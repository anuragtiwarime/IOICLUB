export default function QuestionPaperCard({ paper, onClick }) {
    return (
        <button
            onClick={onClick}
            className="relative min-w-[150px] max-w-full rounded-2xl overflow-hidden bg-neutral-900 border border-neutral-800 hover:border-sky-600 hover:shadow-md transition-all duration-200 w-full sm:max-w-xs md:max-w-sm lg:max-w-md"
        >
            {/* Main Content */}
